...
class Tarefas:
    def __init__(self, nome, vencimento=datetime.now()) -> None:
        self.nome = nome
...
#AQUI ONDE O USUÁRIO DIGITARÁ AS TAREFAS E O TEMPO EM DIAS PRA ELA EXPIRAR.
        tarefa_digitada_pelo_usuário = Tarefas(str(input('DIGITE UMA TAREFA A SER CONCLUÍDA: ')), int(input('QUANTOS DIAS FALTAM PARA A TAREFA EXPIRAR? ')))
